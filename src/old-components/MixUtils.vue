        ...
        <v-layout wrap>
            <v-flex xs12 v-if="userInfo != null">
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <v-file-input accept="image/*" prepend-icon="mdi-camera" label="ارسال تصویر" v-model="files">
                        </v-file-input>
                        <v-switch v-model="tempImageUpload" label="موقت"></v-switch>
                    ...
                    <v-card-text v-if="rImageId != null">
                        <a :href="`${appConfig.$api_url}/api/rimages/${rImageId}.jpg`"
                            target="_blank">{{ appConfig.$api_url }}/api/rimages/{{ rImageId }}.jpg</a>
                    </v-card-text>

                    <v-card-text v-if="rImageId != null">
                        <v-img :src="`${appConfig.$api_url}/api/rimages/${rImageId}.jpg`" class="centeredimg"></v-img>
                    </v-card-text>
                </v-card>
