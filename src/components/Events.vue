            ...
            <v-flex v-if="events != null" xs12>
                <v-data-table dense
                              ...
                              :footer-props="{
                                  ...
                                  firstIcon:'last_page',
                                  lastIcon: 'first_page',
                                  prevIcon: 'keyboard_arrow_right',
                                  nextIcon: 'keyboard_arrow_left',
                    ...
                    <template v-slot:top>
                        <v-toolbar flat color="white">
                            ...
                            <v-text-field label="فیلتر کاربر (دقیق)" v-model="userName"></v-text-field>
                            <v-btn class="mx-2" fab dark x-small color="indigo" @click="enumerateEvents">
    ...
    export default {
        ...
        methods: {
            enumerateEvents() {
                this.loading = true;
                axios({
                    method: "GET", "url": this.appConfig.$api_url + "/api/auditlogs?orderByTimeDescending=" + this.sortDesc + "&userName=" + this.userName + "&PageNumber=" + this.pageNumber + "&PageSize=" + this.pageSize, "data": {},
                    "headers":
                    {
                    ...
                    this.totalEvents = JSON.parse(result.headers['paging-headers']).totalCount;
