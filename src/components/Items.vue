    ...
    export default {
        ...
        methods: {
            ...
            loadArtifacts() {
                ...
                document.title = 'گنجینهٔ گنجور - مشاهدهٔ همه نسخه‌ها - صفحهٔ '+ this.pageNumber;
                if (this.userInfo == null) {
                    axios({ method: "GET", "url": this.appConfig.$api_url + "/api/artifacts?PageNumber=" + this.pageNumber + "&PageSize=" + this.pageSize, "data": {}, "headers": { "content-type": "application/json" } }).then(result => {
                    ...
                    axios({
                        method: "GET", "url": this.appConfig.$api_url + "/api/artifacts/secure?PageNumber=" + this.pageNumber + "&PageSize=" + this.pageSize, "data": {},
                        "headers":
                        {
